...
def cmd_serve(
    ...
    app.run(host=host, debug=debug, use_reloader=debug, port=port, threaded=True)
    return 0
...
def main() -> None:
    ...
    p_serve.add_argument("--debug", action="store_true", help="Enable debug mode with hot reload")
